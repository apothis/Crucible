...
from acestep.api.train_api_lokr_v2_start_route import register_lokr_v2_training_start_route  # Crucible patch 2026-06-08
from acestep.api.train_api_estimate_route import register_estimate_route  # Crucible patch 2026-06-12
from acestep.api.train_api_free_route import register_free_route  # Crucible patch 2026-06-13
...
def register_training_api_routes(
    ...
    # Crucible patch (2026-06-08): register the training_v2 LoKr route over HTTP
    # (/v1/training/start_lokr_v2) - unlocks optimizer_type (incl. prodigy),
    # scheduler_type, cfg_ratio, attention_type. See patches/engine-2026-06-08.
    ...
    # Crucible patch (2026-06-12): gradient-sensitivity ("Fisher") estimation route
    register_estimate_route(app=app, verify_api_key=verify_api_key, wrap_response=wrap_response)
    # Crucible patch (2026-06-13): on-demand VRAM free route (/v1/free) - reclaim GPU mem in-process, no OS restart
    register_free_route(app=app, verify_api_key=verify_api_key, wrap_response=wrap_response)
